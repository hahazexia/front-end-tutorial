...
1. 链接状态必须匹配
1. 焦点状态必须匹配
1. 任何元素都不应受属性选择器的影响，这里所说的“影响”是指在选择器中的任何位置有任何使用了属性选择器的选择器匹配
1. 元素中不能有任何 inline 样式属性
1. 不能使用任何同级选择器。WebCore 在遇到任何同级选择器时，只会引发一个全局开关，并停用整个文档的样式共享（如果存在）。这包括 + 选择器以及 :first-child 和 :last-child 等选择器。
...
<p align="center">
  <img alt="解析css" src="../img/browser15.png">
</p>
<p align="center"><span>Firefox 样式上下文树</span></p>
...
<p align="center">
  <img alt="解析css" src="../img/browser17.png">
</p>
...
<p align="center">
  <img alt="解析css" src="../img/browser18.png">
</p>
...
因此概括来说，共享样式对象（整个对象或者对象中的部分结构）可以解决<a href="#1">问题 1</a> 和<a href="#2">问题 3</a>。Firefox 规则树还有助于按照正确的顺序应用属性。
